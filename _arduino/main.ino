...
const char* password = "YOUR_PASSWORD"; // GANTI DENGAN SSID DAN PASSWORD WIFI ANDA

// REST API
const char* laravelEndpoint = "REST_API_ENDPOINT"; // GANTI DENGAN URL BACKEND LARAVEL ANDA
